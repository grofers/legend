            ...
            "schema": {
                ...
                "alert_config": {
                    ...
                    "schema": {
                        ...
                        "rule": {"type": "dict", "required": False, "schema": {"for_duration": {"type": "string", "required": True}, "evaluate_every": {"type": "string", "required": True},},},
...
schema = {
    ...
    "components": {
        ...
        "schema": {
            ...
            "platform_k8s_cronjob": {"type": "dict", "schema": md(default_panels_schema, platform_k8s_cronjob_schema), "required": False,},
            "platform_k8s_deployment": {"type": "dict", "schema": md(default_panels_schema, platform_k8s_deployment_schema), "required": False,},
            "platform_k8s_hpa": {"type": "dict", "schema": md(default_panels_schema, platform_k8s_hpa_schema), "required": False,},
            "platform_k8s_ingress": {"type": "dict", "schema": md(default_panels_schema, platform_k8s_ingress_schema), "required": False,},
            "redis": {"type": "dict", "schema": md(default_panels_schema, redis_schema), "required": False,},
            "platform_ec2": {"type": "dict", "schema": md(default_panels_schema, platform_ec2_schema), "required": False,},
            ...
            "vault": {"type": "dict", "schema": md(default_panels_schema, vault_schema), "required": False,},
            ...
            "alb": {"type": "dict", "schema": md(default_panels_schema, alb_schema), "required": False,},
            ...
            "starlette": {"type": "dict", "schema": md(default_panels_schema, starlette_schema), "required": False,},
            "nodejs": {"type": "dict", "schema": md(default_panels_schema, nodejs_schema), "required": False,},
            "go": {"type": "dict", "schema": md(default_panels_schema, go_schema), "required": False,},
            "loki": {"type": "dict", "schema": md(default_panels_schema, loki_schema), "required": False,},
        },
    },
}
